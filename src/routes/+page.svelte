...
<div class="space-y-2 font-medium">
	<h1 class="mb-5 text-4xl font-black drop-shadow-xl drop-shadow-indigo-500/50">Report</h1>
	...
	<div class="relative">
		<div
			class="absolute top-0 -z-40 aspect-square overflow-clip mask-[radial-gradient(circle_at_center,black_10%,transparent_85%)]"
		>
			<!-- #region Dots -->
			<svg
	...
	<ul class="my-4 list-inside list-decimal space-y-4 font-bold">
		<li class="text-lg">Coffee</li>
		<li class="text-lg">Tea</li>
		<li class="text-lg">Milk</li>
	</ul>
</div>
